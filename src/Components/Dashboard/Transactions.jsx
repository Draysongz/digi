        ...
        <Tr key={transaction.id}>
          ...
          <Td>
            <HStack>
              ...
              <Text fontWeight={'semibold'} color={transaction.status === 'processing' ? 'yellow.300' :
              transaction.status === 'pending' ? 'yellow.300'  : transaction.status === 'Declined' ? 'red.500' : '#31CD31'
