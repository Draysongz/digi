...
const Giftcards = () => {
  ...
  const TheadBg = useColorModeValue("black", "#0B0449")
  const TBodyBg = useColorModeValue("white", "#141139")
      ...
      <Flex direction={'column'}>
        ...
        <Flex p={7} justifyContent={'space-between'}>
          ...
          <Flex alignItems={'center'} gap={10} px={10}>
            ...
            <Text onClick={() => currentPage === totalPage || currentPage > totalPage ? null : setCurrentPage(currentPage + 1)}
              style={{
                cursor: currentPage === totalPage || currentPage > totalPage ? 'not-allowed' : 'pointer',
